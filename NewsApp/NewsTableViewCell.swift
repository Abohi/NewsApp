...
class NewsTableViewCell: UITableViewCell {
    ...
    override func layoutSubviews() {
        ...
        newsTitleLabel.frame = CGRect(x: 10
                                      , y: 0, width: contentView.frame.size.width-190, height: 70)
        subtitleLabel.frame = CGRect(x: 10
                                      , y: 70, width: contentView.frame.size.width-190, height: contentView.frame.size.height/2)
        
        newsImageView.frame = CGRect(x: contentView.frame.size.width-170
                                      , y: 10, width: 160, height: contentView.frame.size.height-20)
    }
